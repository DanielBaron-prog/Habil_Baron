...
***********************************************************
***********************************************************
* Spezielle Datenaufbereitung für Beispiel "Entscheidung Kind (= pb2)"
...
stset pb_end, id(id) time0(pb_start) origin(time pb_start) failure(pb2_fail==1)
...
* Mediandauer bis Realisierung Erstes gemeinsames Kind

sum pb_dauer if pb2_event==1, detail

***********************************************************

* Deskriptive Statistiken

stsum if pb2_event==1
stdes if pb2_event==1
...
sts graph if pb_dauer <= 180 & pb2_event==1, 									/// restricting X-range to 0 till 180
fail 																			/// graph starts at the bottom of the >-axis instead of the top
title("(g) Erstes gemeinsames Kind (474)") 										/// title
...
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb2 - kind - km_plot.png", replace width(2000)	// format: PNG (for manuscript)
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb2 - kind - km_plot.tif", replace width(2000)	// format: TIFF (for upload)
...
legend(label(1 Unbefristet (410)) label(2 Befristet (64); Log-rank: 1,67)) // Label legend

* Export graph

graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb2 - kind - km_plot + logrank.png", replace width(2000)	// format: PNG (for manuscript)
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb2 - kind - km_plot + logrank.tif", replace width(2000)	// format: TIFF (for upload)
