...
***********************************************************
***********************************************************
* Spezielle Datenaufbereitung für Beispiel "Entscheidung Immobilie (= pb8)"

* Variable "pb8_fail" generieren, die den Eintritt des Ereignises widergibt

gen pb8_fail = 0

move pb8_fail eb_beginn1

replace pb8_fail = 1 if pb_dauer==pb8_risktime & pb8_event==1

drop if pb8_event==1 & pb_dauer>pb8_risktime

tab pb8_fail if pb8_fail==1
...
stset pb_end, id(id) time0(pb_start) origin(time pb_start) failure(pb8_fail==1)
...
* Invertieren Variable Staatsangehoerigkeit
...
* Mediandauer bis Realisierung Erwerbs einer Wohnimmobilie

sum pb_dauer if pb8_event==1, detail

***********************************************************

* Deskriptive Statistiken

stsum if pb8_event==1
stdes if pb8_event==1
...
sts graph if pb_dauer <= 180 & pb8_event==1, 						/// restricting X-range to 0 till 180
fail 																/// graph starts at the bottom of the >-axis instead of the top
title("(h) Erwerb einer Wohnimmobilie (285)") 						/// title
...
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb8 - immobilie - km_plot.png", replace width(2000)	// format: PNG (for manuscript)
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb8 - immobilie - km_plot.tif", replace width(2000)	// format: TIFF (for upload)
...
legend(label(1 Unbefristet (258)) label(2 Befristet (27); Log-rank: 8,56**)) // Label legend

* Export graph

graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb8 - immobilie - km_plot + logrank.png", replace width(2000)	// format: PNG (for manuscript)
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb8 - immobilie - km_plot + logrank.tif", replace width(2000)	// format: TIFF (for upload)