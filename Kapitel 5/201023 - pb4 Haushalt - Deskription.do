...
***********************************************************
***********************************************************
* Spezielle Datenaufbereitung für Beispiel "Entscheidung Haushalt (= pb4)"

* Variable "pb4_fail" generieren, die den Eintritt des Ereignises widergibt

gen pb4_fail = 0

move pb4_fail eb_beginn1

replace pb4_fail = 1 if pb_dauer==pb4_risktime & pb4_event==1

drop if pb4_event==1 & pb_dauer>pb4_risktime

tab pb4_fail if pb4_fail==1
...
stset pb_end, id(id) time0(pb_start) origin(time pb_start) failure(pb4_fail==1)
...
* Mediandauer bis Realisierung EZusammenzug

sum pb_dauer if pb4_event==1, detail

***********************************************************

* Deskriptive Statistiken

stsum if pb4_event==1
stdes if pb4_event==1
...
sts graph if pb_dauer <= 180 & pb4_event==1, 								/// restricting X-range to 0 till 180
fail 																		/// graph starts at the bottom of the >-axis instead of the top
title("(b) Zusammenzug (845)") 												/// title
...
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb4 - haushalt - km_plot.png", replace width(2000)	// format: PNG (for manuscript)
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb4 - haushalt - km_plot.tif", replace width(2000)	// format: TIFF (for upload)
...
legend(label(1 Unbefristet (699)) label(2 Befristet (146); Log-rank: 0,02)) // Label legend

* Export graph

graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb4 - haushalt - km_plot + logrank.png", replace width(2000)	// format: PNG (for manuscript)
graph export "E:\Habilschrift\Analysen Kap5 - Methoden und Deskription\Stata Plots\pb4 - haushalt - km_plot + logrank.tif", replace width(2000)	// format: TIFF (for upload)